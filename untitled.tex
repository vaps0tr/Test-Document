...
I am happy to use this, but I think we need a little more testing particularly of integration with Word. One big concern is I'm not clear whether it's at all portable offline. With sharelatex, you're editing a normal LaTeX document, so you can download and use in a LaTeX editor. With this, it's not a complete LaTeX doc. The other concern is related. 
