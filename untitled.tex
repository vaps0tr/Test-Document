...
The export options are Word, PDF, LaTex, and "Zip". It seems like you could download this and edit in a normal LaTeS editor. The backend is a LaTex document. If you click on the "Document" menu you can go edit the formats like you have with LaTeX.
