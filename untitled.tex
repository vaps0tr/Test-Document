...
The export options are Word, PDF, LaTeX, and "Zip". It seems like you could download this and edit in a normal LaTeX editor. The backend is a LaTeX document. If you click on the "Document" menu you can go edit the formats like you have with LaTeX. I think the real 
